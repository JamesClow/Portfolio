(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      /// ---------------------------      
      options                     = options || {};
      options.stageWidth          = options.hasOwnProperty('stageWidth') ? options.stageWidth : "100%";
      options.stageHeight         = options.hasOwnProperty('stageHeight') ? options.stageHeight : "100%";
      ...
      this.initPixi = function() {
        ...
        if ( options.fullScreen === true ) {
          ...
          renderer.view.style.webkitTransform = 'scale(1.1)';
          renderer.view.style.transform = 'scale(1.1)';     
        } else {
